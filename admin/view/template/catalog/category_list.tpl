  ...
  <table class="list">
    ...
    <thead>
      ...
      <tr>
        ...
        <td class="left"><?php echo $column_nb_products; ?></td>
<!-- add number of products colomn-->
    ...
    <tbody>
      ...
      <tr class="<?php echo $class; ?>">
        ...
        <td class="left"><?php echo $category['name']; ?></td>
          <!--display number of product of each category-->
        <td class="left"><?php 
        if(!empty($category['nb_products']))
        echo $category['nb_products'];
        else
        echo '0'; ?></td>
