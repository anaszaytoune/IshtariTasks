<?php 
class ControllerCatalogAdvancedCategory extends Controller { 
	private $error = array();
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$this->data['categories'][] = array(
				...
				'action'      => $action,
				'products'    => $this->model_catalog_advanced_product->getTotalProducts(array('filter_category_id'=>$result['category_id']))
			);
		}
		...
		$this->template = 'catalog/advanced_category_list.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
