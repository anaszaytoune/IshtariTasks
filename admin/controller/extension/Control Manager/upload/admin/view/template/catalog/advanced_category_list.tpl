        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="right"><a href="index.php?route=catalog/advanced_product&token=<?php echo $token; ?>&filter_category=<?php echo $category['category_id'];?>"><?php echo $category['products']; ?></a></td>
