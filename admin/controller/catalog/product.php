	...
	private $error = array(); 
  	...
  	private function getList() {				
		...
		$data = array(
			...
			'cost'	 => @$this->request->get['filter_cost'], //add cost value getting from url to data array
		...
		foreach ($results as $result) {
			...
			$action[] = array(
      		...
      		$this->data['products'][] = array(
				...
				'name'       => $result['name'],
				'model'      => $result['model'],
				'cost'		 => $result['cost'],//send product cost to view
		...
		$this->data['column_cost'] = $this->language->get('column_cost');//get cost colomn name
		...
		$this->data['sort_cost'] = $this->url->https('catalog/product&sort=p.cost' . $url);
		...
		$this->data['filter_cost'] = @$this->request->get['filter_cost'];//add cost value getting from url to data array
